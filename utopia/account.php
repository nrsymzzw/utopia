  ...
  <div style="margin-top:45px">
	<form>
	    ...
	    <tr>
			...
			<td>
			  <label>
				<?php echo $row['membername'] ?></label></td>
		</tr>
		
		<tr>		
			<td><b>IC Number</b></td>
			<td>
			  <label><?php echo $row['memberic'] ?></label></td>
		</tr>
		
		<tr>
			<td><b>Contact Number</b></td>
			<td>
			  <label><?php echo $row['memberphone'] ?></label></td>
		</tr>
		
		<tr>
		  	<td><b>Email</b></td>
			<td>
			  <label><?php echo $row['memberemail'] ?></label></td>
		</tr>
		
		<tr>
		  	<td><b>Password</b></td>
			<td>
			  <label><?php echo $row['memberpassword'] ?></label></td>
		</tr>
		</table>
			
		<br><br>
		<p class="button" style="font-family: Arial;  float: right;">
			<a href="editmember.php?memberid=<?php echo $row['memberid']; ?>" ><b>Update Account</b></a>			
		</p>		
	</form>
  </div>
